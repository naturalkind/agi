...
#svg_logo = cairosvg.svg2png(url=png_file_path, write_to=svg_file_path)
...
class MessageHandler(tornado.web.RequestHandler):
    ...
    async def send_start_menu(self, chat_id, message_id):
        ...
        image_path = '/media/sadko/1b32d2c7-3fcf-4c94-ad20-4fb130a7a7d4/PLAYGROUND/LLM/robots-AI.jpg'  # Replace with your actual image path
